...
def main(global_config, **settings):
    ...
    config.add_route("issues_ack",     "/issues/ack",    request_method="POST")
    config.add_route("crashes",        "/crashes")
    config.add_route("crashes_clear",  "/crashes/clear", request_method="POST")
    config.add_route("crashes_dump",   "/crashes/dump")
